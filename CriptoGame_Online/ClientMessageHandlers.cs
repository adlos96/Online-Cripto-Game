...
namespace Warrior_and_Wealth
{
    internal class ClientMessageHandlers
    {
        ...
        public static void Quest(string messaggio)
        {
        ...
        public static void Update_Data(string[] mess)
        {
        ...
        public static void Update_Desc(string tipo, string desc)
        {
            switch (tipo)
            {
                case "Esperienza":
        ...
        public static void Update_PVP_List(string[] mess)
        {
        ...
        public static int GetPotenzaValue(string playerString)
        {
            try
            {
        ...
        public static void Update_Lista_Raduni(string[] mess)
        {
        ...
        public static void Update_Lista_Raduni_Player(string[] mess)
        {
            // Ignora il primo elemento (che è "Lista_Raduni")
            // e ricostruisci la stringa originale
            var datiCompleti = string.Join("|", mess.Skip(1)).Split('-');
        ...
        public static async void Update_Raduni_Partecipazione(string[] mess)
        {
